// Specific serverless function for GET /api/spreads/:id
// Vercel routing prioritizes specific patterns over catch-all, so this ensures
// the dynamic :id route is handled properly with CORS preflight support.
...
module.exports = (req, res) => {
	// Handle CORS preflight for the specific spreads/:id route
	...
	try {
		...
		if (!req.url.startsWith('/api')) {
			req.url = `/api/spreads/${req.query.id || ''}`
		}
	} catch (e) {
		// ignore and proceed
	}
