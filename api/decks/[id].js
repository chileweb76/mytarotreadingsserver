// Specific serverless function for /api/decks/:id routes
// Handles GET /api/decks/:id and DELETE /api/decks/:id with proper CORS preflight
...
module.exports = (req, res) => {
	// Handle CORS preflight for the specific decks/:id route
	...
	try {
		...
		if (!req.url.startsWith('/api')) {
			req.url = `/api/decks/${req.query.id || ''}`
		}
	} catch (e) {
		// ignore and proceed
	}
