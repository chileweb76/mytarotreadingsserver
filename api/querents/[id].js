// Specific serverless function for /api/querents/:id routes
// Handles DELETE /api/querents/:id with proper CORS preflight
...
module.exports = (req, res) => {
	// Handle CORS preflight for the specific querents/:id route
	...
	try {
		...
		if (!req.url.startsWith('/api')) {
			req.url = `/api/querents/${req.query.id || ''}`
		}
	} catch (e) {
		// ignore and proceed
	}
