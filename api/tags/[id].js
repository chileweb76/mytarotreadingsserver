// Specific serverless function for /api/tags/:id routes
// Handles DELETE /api/tags/:id with proper CORS preflight
...
module.exports = (req, res) => {
	// Handle CORS preflight for the specific tags/:id route
